...
function getRestaurent(restaurent){

    restaurent.forEach((restaurent)=>{
        ...
        image.src= `${restaurent.image}.jpeg`;
    ...
    //card footer 
        ...
        const location = document.createElement('div');
         ...
         distance.textContent = restaurent.distance_from_Customer_house+"km";
...
document.getElementById('alcohal').addEventListener('click',()=>{
    const result = restaurent.filter((obj)=>obj.alcohol);
...
document.getElementById('rating').addEventListener('click',()=>{
    const result = restaurent.filter((obj)=>obj.rating>4.5);
    document.getElementById('root').innerHTML="";
    getRestaurent(result);
})

document.getElementById('open').addEventListener('click',()=>{
    const result = restaurent.filter((obj)=>obj.restaurant_open_time);
    document.getElementById('root').innerHTML="";
    getRestaurent(result);
})
...
document.getElementById('offers').addEventListener('click',()=>{
    const result = restaurent.filter((obj)=>obj.offers>20);
    document.getElementById('root').innerHTML="";
    getRestaurent(result);
})
...
document.getElementById('applyFilter').addEventListener('click',()=>{
        ...
        if(answer==="rating"){
            restaurent.sort((a , b)=>b.rating-a.rating);
        }

        else if(answer==="highLow"){
            restaurent.sort((a,b)=>b.price_for_two - a.price_for_two);

        }

        else if(answer==="costLowHigh"){
            restaurent.sort((a,b)=> a.price_for_two - b.price_for_two);

        }

        else if(answer==="distance"){
            restaurent.sort((a,b)=> a.distance_from_Customer_house - b.distance_from_Customer_house);
